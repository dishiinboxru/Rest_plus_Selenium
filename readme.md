...
most major one - 6 - petstore web-site itself is too sluggish - even manually checking those cases you can notice get and delete responses being incorrect if you don't wait or retry several times.
Thread sleep doesn't solve the situation so I leave it as is.
...
Time estimates to complete the whole thing
